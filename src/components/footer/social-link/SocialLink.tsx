...
/**
 * Social icon link component for footer
 */
export default class SocialLink extends Component<SocialLinkProps> {
  render({href}: SocialLinkProps) {
    return(
      <a href={href} class='social-link' target='_blank' rel='noopener noreferrer'>{this.props.children}</a>
    );
  }
}

/**
 * GH icon for social links
 */
export class GH extends Component {
  render() {
    return (
      <svg class="social-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="64px" height="64px"
        aria-labelledby="ghId">
        <title id="ghId">GitHub</title>
        <path
...
/**
 * LN icon for social links
 */
export class LN extends Component {
  render() {
    return (
      <svg class="social-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="64px" height="64px"
        aria-labelledby="lnId">
        <title id="lnId">LinkedIn</title>
        <path
